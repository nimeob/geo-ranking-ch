...
- **Fortschritt (2026-02-26):**
  ...
  - ✅ 2026-02-26: #81 abgeschlossen (BL-20.1.f.wp3 Worked Examples) mit drei reproduzierbaren Score-Fallstudien inkl. Referenzartefakten unter [`docs/api/examples/scoring/`](api/examples/scoring/) und Reproduzierbarkeits-Checks in `tests/test_api_field_catalog.py`.
