...
- [#892](https://github.com/nimeob/geo-ranking-ch/issues/892) — INFRA-NET-dev.followup.wp5: Frontdoor/VPC alignment for private ECS subnets (priority:P1, status:todo; Fortschritt: wp1 #895 + wp2 #896 abgeschlossen, offen: #897; unblocks #889/#886)
...
- [#882](https://github.com/nimeob/geo-ranking-ch/issues/882) — INFRA-NET-dev.followup: NAT egress for private ECS subnets (priority:P1, status:blocked; Fortschritt: #884 + #885 + #889 abgeschlossen, offen bleibt #886 Runtime-Validation)
- [#886](https://github.com/nimeob/geo-ranking-ch/issues/886) — INFRA-NET-dev.followup.wp3: Runtime validation ECS private-egress (priority:P1, status:todo; nach Abschluss #889 jetzt ausführbar, Evidence-Lauf ausstehend)
...
- ✅ abgeschlossen (2026-03-03, revalidiert): [#860](https://github.com/nimeob/geo-ranking-ch/issues/860) — INFRA-NET-0-dev: Dev Network (VPC/Subnets/SGs) via Terraform — Dev-Network-Outputs in `infra/terraform/outputs.tf` vervollständigt (`dev_vpc_id`, private/public Subnet-IDs, SG-IDs), Regressionstest `tests/test_dev_network_outputs_tf.py` ergänzt, Evidence: `reports/evidence/issue-860-network-closeout-2026-03-03.md`; NAT-Egress-Folgearbeit separat in [#882](https://github.com/nimeob/geo-ranking-ch/issues/882).
