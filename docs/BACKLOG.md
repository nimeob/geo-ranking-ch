...
- ✅ abgeschlossen (2026-03-02): [#812](https://github.com/nimeob/geo-ranking-ch/issues/812) — DB-0.wp1: Canonical SQL schema v1 (organizations/users/memberships/api_keys) + Test — neues Schema-Artefakt `docs/sql/db_core_schema_v1.sql` (Postgres) + Regressiontest `tests/test_db_core_schema_sql.py`. (PR #TBD)
