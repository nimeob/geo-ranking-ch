...
- [#882](https://github.com/nimeob/geo-ranking-ch/issues/882) — INFRA-NET-dev.followup: NAT egress for private ECS subnets (priority:P1, status:todo; Child-WPs #884 + #885 + #889 + #886 abgeschlossen, Parent-Closeout/Statussync ausstehend)
