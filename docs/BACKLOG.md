...
- ✅ abgeschlossen (2026-03-02): [#858](https://github.com/nimeob/geo-ranking-ch/issues/858) — INFRA-DB-0-dev.wp2: ECS Secrets Wiring für dev (dev_ecs_compute.tf) — `infra/terraform/dev_ecs_compute.tf`: DB_PASSWORD via SecretsManager valueFrom (kein Plaintext), DB_HOST/PORT/NAME/USERNAME als plain env, ARN-Auflösung (override oder RDS auto-managed); `docs/DEV_DB_ECS_SECRETS_RUNBOOK.md`. Commit: 41eef0c
