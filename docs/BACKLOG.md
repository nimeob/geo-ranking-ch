...
- **Nächster Schritt (oldest-first, unblocked):** Nach #396 als nächstes ältestes unblocked BL-337-Work-Package #397 (API-Frontdoor Internet-E2E Execution) claimen und ausführen.
