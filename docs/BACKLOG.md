...
- ✅ abgeschlossen (2026-03-03): [#939](https://github.com/nimeob/geo-ranking-ch/issues/939) — GUI Auth UX Parent: Login-Seite + session-basiertes OIDC ohne manuelle Bearer-Tokens — Parent-Abschluss nach vollständiger WP-Umsetzung (#944/#945/#946/#947); Acceptance-Checklist und Work-Package-Status synchronisiert, Nachweise in `docs/gui/GUI_AUTH_BFF_SESSION_FLOW.md`, `docs/testing/GUI_AUTH_SMOKE_RUNBOOK.md` und `reports/evidence/issue-947-gui-auth-e2e-cookie-evidence-20260303T171208Z.md`.
