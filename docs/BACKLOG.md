...
- ✅ abgeschlossen (2026-03-02): [#833](https://github.com/nimeob/geo-ranking-ch/issues/833) — INFRA-DB-0.wp4: Lokale Dev-DB (docker-compose Postgres) für Dev/Test-Harness — `docker-compose.dev.yml` (Postgres 16 Alpine, Healthcheck, Volume), `.env.example` (DATABASE_URL), `scripts/db-local.sh` (start/stop/reset/migrate/psql), `docs/local-dev.md` (Step-by-Step Guide). Commit: 14d06ad
