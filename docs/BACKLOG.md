...
- ✅ abgeschlossen (2026-03-02): [#860](https://github.com/nimeob/geo-ranking-ch/issues/860) — INFRA-NET-0-dev: Dev Network (VPC/Subnets/SGs) via Terraform — `infra/terraform/dev_network.tf`: VPC, private/public Subnets, IGW, Route Tables, Security Groups für dev. Commit: 41eef0c
