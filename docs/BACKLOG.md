...
- ✅ abgeschlossen (2026-03-02): [#778](https://github.com/nimeob/geo-ranking-ch/issues/778) — UI/Prod: History Page (/history) + Links zu Result Pages — separate `/history` Page (stdlib-only) lädt `GET /analyze/history` und verlinkt pro Item auf `/results/<result_id>` + ui_service Smoke-Assertion (`tests/test_ui_service.py`).
