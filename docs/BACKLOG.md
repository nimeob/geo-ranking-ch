...
- ✅ abgeschlossen (2026-03-02): [#817](https://github.com/nimeob/geo-ranking-ch/issues/817) — OIDC-0.wp1: API JWT Validation (RS256, JWKS cache, iss/aud/exp/nbf checks) — stdlib-only Helper `src/api/oidc_jwt.py` + Unit-Tests `tests/test_oidc_jwt_validation.py`. (PR #821)
