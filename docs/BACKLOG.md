...
### Now
- [#577](https://github.com/nimeob/geo-ranking-ch/issues/577) — BL-30/BL-15 Follow-up: GTM → Data Architecture Mapping v1 (Org/User/Billing/Entitlements) (priority:P2, status:in-progress)
