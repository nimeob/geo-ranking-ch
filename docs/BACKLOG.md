...
- **Umgesetzt (Iteration 2026-02-26, laufend):**
  ...
  - Reproduzierbarkeits-Check erneuert: `./scripts/run_webservice_e2e.sh` erfolgreich (`113 passed`, Exit `0`) direkt vor dem dedizierten Worker-A-10m-Langlauf (Smoke + 3x Stabilität).
