...
- **Nächster Schritt (oldest-first, unblocked):** BL-337 ist abgeschlossen; als nächstes globales unblocked Backlog-Issue mit `backlog + status:todo` claimen (aktuell kein weiteres BL-337-Leaf offen).
