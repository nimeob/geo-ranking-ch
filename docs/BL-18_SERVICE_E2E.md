...
- `SMOKE_OUTPUT_JSON` (optional): wird vor der Verwendung getrimmt; Pfade mit Steuerzeichen werden fail-fast mit `exit 2` abgewiesen, damit die Artefakt-Ausgabe robust und konsistent bleibt (inkl. Curl-Fehlpfad-Report).
