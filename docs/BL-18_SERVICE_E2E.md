...
- `SMOKE_OUTPUT_JSON` (optional): wird vor der Verwendung getrimmt; so bleibt die Artefakt-Ausgabe auch bei whitespace-umhüllten Pfaden robust und konsistent (inkl. Curl-Fehlpfad-Report).
