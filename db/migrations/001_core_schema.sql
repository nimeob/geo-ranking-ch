...
-- Description: Core multi-tenant identity tables (organizations/users/memberships/api_keys)
-- Issue: #801 (DB-0.wp1 canonical schema — #812)
...
CREATE TABLE IF NOT EXISTS api_keys (
  ...
  -- Full secret material is NEVER stored. Hash is produced with a strong, versioned scheme.
  -- Example schemes: hmac_sha256_v1, argon2id_v1, bcrypt_v1.
