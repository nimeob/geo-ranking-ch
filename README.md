...
# optional: DEV_API_AUTH_TOKEN wird vor Verwendung getrimmt; whitespace-only Werte und Steuerzeichen werden fail-fast mit exit 2 abgewiesen
# optional: SMOKE_OUTPUT_JSON wird vor der Nutzung getrimmt; Pfade mit Steuerzeichen werden fail-fast mit exit 2 abgewiesen (robuste/sichere Artefaktausgabe auch bei whitespace-umhüllten Pfaden)
