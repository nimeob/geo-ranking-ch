...
# DEV_BASE_URL muss http(s) sein (auch mit grossgeschriebenem Schema wie HTTP://); führende/trailing Whitespaces sowie /health-/analyze-Suffixe werden automatisch normalisiert
