...
# DEV_BASE_URL muss http(s) sein (auch mit grossgeschriebenem Schema wie HTTP://); führende/trailing Whitespaces, redundante trailing Slashes sowie /health-/analyze-Suffixe (case-insensitive, auch verkettet und in gemischter Reihenfolge wie /analyze/health) werden automatisch normalisiert
