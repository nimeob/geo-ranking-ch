...
try:
    ...
    from src.api.address_intel_confidence import (
        assess_ambiguity as _assess_ambiguity_impl,
        compute_confidence as _compute_confidence_impl,
    )
    ...
    from address_intel_confidence import (  # type: ignore[no-redef]
        assess_ambiguity as _assess_ambiguity_impl,
        compute_confidence as _compute_confidence_impl,
    )
...
def compute_confidence(
    *,
    ...
    return _compute_confidence_impl(
        selected=selected,
        candidates=candidates,
        sources=sources,
        heating_layer=heating_layer,
        plz_layer=plz_layer,
        admin_boundary=admin_boundary,
        osm=osm,
