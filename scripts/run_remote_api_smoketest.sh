...
PY
then
  echo "[BL-18.1] SMOKE_QUERY darf keine Steuerzeichen enthalten." >&2
  exit 2
fi
...
PY
then
  echo "[BL-18.1] SMOKE_REQUEST_ID darf keine eingebetteten Whitespaces enthalten." >&2
  exit 2
fi
